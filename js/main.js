...
observer.observe(document.querySelector('main'), { attributes: true, subtree: true });
  ...
  if ((excolAll !== null) && (excols !== null) && (excols.length > 1)) {
    ...
    Array.prototype.forEach.call(excolAll, function(el, i){
      el.innerHTML = '<button class="expand button button-secondary button-small">+ Expandir Todas as Secções</button> <button class="collapse button button-secondary button-small">&minus; Colapsar Todas as Secções</button>';
    });
